...
enterpriseSearchApp.directive('fcgraph', ["$compile", "$window", "$rootScope", "DataService", function ($compile, $window, $rootScope, DataService) {
  ...
  directive.link = function ($scope, element, attributes) {
    ...
    var canvasDim = {
      ...
      height: function () {
        ...
        //return CANVAS_HEIGHT - margin.top - margin.bottom;
    ...
    function drawFCGraph(graphData, contextSession) {
      ...
      graphData.forEach(function (d, i) {
        ...
        array.forEach(function (c, i) {
          ...
          nodes.push({id: c.id, session: session, user: user, time: time, x: 0, y: 0});
        });
      });
    ...
    console.log("call function drawFCGraph:");
    drawFCGraph(DataService.getGraphData(), 2);
